...
class NavierStokesReactingIntInters(BaseAdvectionDiffusionIntInters):
    def __init__(self, be, lhs, rhs, elemap, cfg):
        ...
        be.pointwise.register('pyfr.solvers.navstokesReacting.kernels.intconu')
        be.pointwise.register('pyfr.solvers.navstokesReacting.kernels.intcflux')
...
class NavierStokesReactingMPIInters(BaseAdvectionDiffusionMPIInters):
    def __init__(self, be, lhs, rhsrank, rallocs, elemap, cfg):
        ...
        be.pointwise.register('pyfr.solvers.navstokesReacting.kernels.mpiconu')
        be.pointwise.register('pyfr.solvers.navstokesReacting.kernels.mpicflux')
...
class NavierStokesReactingBaseBCInters(BaseAdvectionDiffusionBCInters):
    cflux_state = None
    ...
    def __init__(self, be, lhs, elemap, cfgsect, cfg):
        ...
        be.pointwise.register('pyfr.solvers.navstokesReacting.kernels.bcconu')
        be.pointwise.register('pyfr.solvers.navstokesReacting.kernels.bccflux')
...
class NavierStokesReactingNoSlpIsotWallBCInters(NavierStokesReactingBaseBCInters):
...
class NavierStokesReactingNoSlpAdiaWallBCInters(NavierStokesReactingBaseBCInters):
    type = 'no-slp-adia-wall'
    cflux_state = 'ghost'


class NavierStokesReactingSlpAdiaWallBCInters(NavierStokesReactingBaseBCInters):
    type = 'slp-adia-wall'
    cflux_state = None


class NavierStokesReactingCharRiemInvBCInters(NavierStokesReactingBaseBCInters):
    type = 'char-riem-inv'
    cflux_state = 'ghost'
...
class NavierStokesReactingSupInflowBCInters(NavierStokesReactingBaseBCInters):
    type = 'sup-in-fa'
    cflux_state = 'ghost'
...
class NavierStokesReactingSupOutflowBCInters(NavierStokesReactingBaseBCInters):
    type = 'sup-out-fn'
    cflux_state = 'ghost'


class NavierStokesReactingSubInflowFrvBCInters(NavierStokesReactingBaseBCInters):
    type = 'sub-in-frv'
    cflux_state = 'ghost'
    ...
    def __init__(self, be, lhs, elemap, cfgsect, cfg):
        ...
        tplc = self._exp_opts(
            ['rho', 'u', 'v', 'w','Y0','Y1'][:self.ndims + 1], lhs,
            default={'u': 0, 'v': 0, 'w': 0}
        )
        self._tpl_c.update(tplc)


class NavierStokesReactingSubInflowFtpttangBCInters(NavierStokesReactingBaseBCInters):
...
class NavierStokesReactingSubOutflowBCInters(NavierStokesReactingBaseBCInters):
    type = 'sub-out-fp'
    cflux_state = 'ghost'
