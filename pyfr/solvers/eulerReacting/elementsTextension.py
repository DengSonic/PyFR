...
class BaseFluidReactingElements(object):
    ...
    privarmapT = {2: ['rho', 'u', 'v', 'p','Y0','Y1', 'T'],
                 3: ['rho', 'u', 'v', 'w', 'p','Y0','Y1', 'T']}

    convarmap = {2: ['rho', 'rhou', 'rhov', 'E','rhoY0','rhoY1'],
                 3: ['rho', 'rhou', 'rhov', 'rhow', 'E','rhoY0','rhoY1']}

    convarmapT = {2: ['rho', 'rhou', 'rhov', 'E','rhoY0','rhoY1', 'T'],
                 3: ['rho', 'rhou', 'rhov', 'rhow', 'E','rhoY0','rhoY1', 'T']}
